...
export default function MwTableSearchInput({
  value,
  onChange,
  placeholder,
  className = '',
  inputClassName = '',
}: MwTableSearchInputProps) {
  ...
  return (
    <div className={`relative group ${className}`}>
      ...
      <input
        ...
        className={`mw-input pl-11 ${hasText ? 'pr-10' : ''} ${inputClassName}`.trim()}
      />
      {hasText && (
        <button
          type="button"
