package com.mostwanted.app.ui.scan
 ...
 */
class MwQrCaptureActivity : CaptureActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        content?.post {
            ...
            val toolbar = Toolbar(this).apply {
                ...
                elevation = 4f
                navigationIcon = ContextCompat.getDrawable(this@MwQrCaptureActivity, R.drawable.mw_ic_arrow_back)
