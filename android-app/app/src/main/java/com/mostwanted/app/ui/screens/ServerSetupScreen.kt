...
import com.mostwanted.app.ui.scan.MwQrCaptureActivity
import com.mostwanted.app.api.EnrollmentProbe
...
import com.mostwanted.app.ui.components.AppButtonVariant
...
import com.mostwanted.app.ui.theme.MwBgPrimary
...
import com.mostwanted.app.util.MobileConnectionQrParser
...
fun ServerSetupScreen(
    ...
    val scanOptions = remember {
        ScanOptions().apply {
            ...
            setPrompt("Olvasd be a Most Wanted Android QR-kódot")
            setBeepEnabled(false)
            setCaptureActivity(MwQrCaptureActivity::class.java)
        }
    }
            ...
            AppGlassCard(
                ...
                if (fromLogin) {
                    ...
                    TextButton(onClick = onBackFromLoginFlow, modifier = Modifier.fillMaxWidth()) {
                        Text("Vissza a bejelentkezéshez", color = MwTextMuted)
                    }
                }
            }
            }
        ...
        Dialog(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "A szervező admin oldalán generált Most Wanted QR-t olvasd be. A kamera megnyitása után a rendszer kameraalkalmazásában a vissza gombbal is kiléphetsz.",
                        style = MaterialTheme.typography.bodyMedium,
                        color = MwTextSecondary,
                    )
