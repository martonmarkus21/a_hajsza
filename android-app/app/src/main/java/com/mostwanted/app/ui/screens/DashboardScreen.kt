...
import com.mostwanted.app.model.LiveDashboardIcon
import com.mostwanted.app.ui.components.AppButton
import com.mostwanted.app.ui.components.AppDangerOutlinedButton
import com.mostwanted.app.ui.components.AppGlassCard
import com.mostwanted.app.ui.components.AppOutlinedActionButton
import com.mostwanted.app.ui.components.AppPairNumberBadge
import com.mostwanted.app.ui.components.UnreadCountPill
...
import com.mostwanted.app.util.LiveCountdownFormatter
    ...
    LazyColumn(
        ...
        item {
            Row(
                ...
                Image(
                    painter = painterResource(id = R.drawable.mw_logo_small),
                ...
                Row(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Text(
                            ...
                            color = if (live?.headlineIsActive == true) MwTextPrimary else MwTextSecondary,
                    ...
                    live.scheduleSummaryLines.forEach { line ->
                        Row(
                            ...
                            Text(
                                ...
                                color = MwOrange.copy(alpha = 0.75f),
                            )
                            Text(
                                text = line,
                                style = MaterialTheme.typography.bodyMedium,
            ...
            AppGlassCard(modifier = Modifier.fillMaxWidth(), contentPadding = PaddingValues(18.dp)) {
                Row(
                    ...
                    Icon(
                        ...
                        contentDescription = null,
                        tint = MwOrange.copy(alpha = 0.85f),
                ...
                Text(
                    ...
                    style = MaterialTheme.typography.bodyLarge,
                    color = if (uiState.message.isBlank()) MwTextMuted else MwTextPrimary,
                )
            }
        }
...
private fun statusIconFor(
    ...
    return when (kind) {
        LiveDashboardIcon.FinalDay ->
            Icons.Rounded.Flag to MwOrange
        LiveDashboardIcon.LivePlay ->
            Icons.Rounded.PlayCircle to MwOrange
        LiveDashboardIcon.Ended ->
            Icons.Rounded.TaskAlt to MwTextSecondary
        LiveDashboardIcon.BetweenDays ->
            Icons.Rounded.NightsStay to MwTextSecondary
        LiveDashboardIcon.GameOff ->
            Icons.Rounded.PowerSettingsNew to MwTextMuted
        LiveDashboardIcon.IdleWait ->
            Icons.Rounded.Schedule to MwTextSecondary
        LiveDashboardIcon.Paused ->
            Icons.Rounded.PauseCircle to MwTextSecondary
        null ->
            if (headlineActive) Icons.Rounded.PlayCircle to MwOrange
            else Icons.Rounded.PauseCircle to MwTextSecondary
    }
}
